...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "API em ASP.NET para gerenciamento de um sistema de pesquisa de satisfação.",
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Satisfaction Survey API");
